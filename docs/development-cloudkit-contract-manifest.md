...
| `kindVersionCounter` | `Int64` | no |
| `kindVersionReplicaID` | `String` | no |
| `singleMemoFont` | `String` | no |
| `singleMemoFontVersionCounter` | `Int64` | no |
| `singleMemoFontVersionReplicaID` | `String` | no |
...
| `lifecycleVersionCounter` | `Int64` | no |
| `lifecycleVersionReplicaID` | `String` | no |
| `indentLevel` | `Int64` | no |
| `indentVersionCounter` | `Int64` | no |
| `indentVersionReplicaID` | `String` | no |
