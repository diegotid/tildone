...
- The Development contract is exactly `TDNote` V1/V2/V3, `TDTask` V1/V2/V3, and advisory `TDClient` V1 in the private custom zone. Reconcile field changes with `docs/development-cloudkit-contract-manifest.md` and its source generator/tests.
