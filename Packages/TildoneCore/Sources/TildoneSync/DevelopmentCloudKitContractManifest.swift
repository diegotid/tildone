...
public enum DevelopmentCloudKitContractManifest {
    ...
    private static let noteV3Fields = noteV2Fields + [
        CloudKitContractField(CloudKitRecordMapper.Field.kind, .string),
        CloudKitContractField(CloudKitRecordMapper.Field.kindCounter, .int64),
